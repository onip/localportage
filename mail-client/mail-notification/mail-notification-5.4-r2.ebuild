...
src_unpack() {
	...
	# If no internet connection is available then mn starts eating all cpu
	# see https://bugs.launchpad.net/mail-notification/+bug/182923
	epatch "${FILESDIR}/${P}-avoid_burning_cpu_if_no_connection_is_available.patch"
}
