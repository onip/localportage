...
# $Header: /var/cvsroot/gentoo-x86/media-gfx/blender/blender-2.58a.ebuild,v 1.3 2011/07/08 10:22:39 ssuominen Exp $
...
src_prepare() {
	...
	#epatch "${FILESDIR}"/${PN}-2.57-libav-0.7.patch
	#epatch "${FILESDIR}"/${PN}-2.57-CVE-2009-3850-v2.patch
	...
	rm -r extern/glew
#	epatch "${FILESDIR}"/${PN}-2.57-glew.patch
