...
# $Header: /var/cvsroot/gentoo-x86/media-video/ffmpeg/ffmpeg-0.6_p25423.ebuild,v 1.3 2010/10/11 22:13:00 maekke Exp $
...
src_prepare() {
	...
	# runtime cpudetection compilation fix
	epatch "${FILESDIR}/runtime-cpudetection-build-fix.patch"
}
